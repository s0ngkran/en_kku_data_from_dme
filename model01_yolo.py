...
class HandModel(torch.nn.Module):
    def __init__(self, input_channel):
        ...
        no_relu_layers = []
        vgg = OrderedDict([
                      ('conv1_1', [input_channel, 64, 7, 2, 1]), 
                      ('pool1_stage1', [2, 2, 0]),
                      ('conv2_1', [64, 192, 3, 1, 1]),
                      ('pool2_stage1', [2, 2, 0]),
                      ('conv3_1', [192, 128, 1, 1, 1]),
                      ('conv3_2', [128, 256, 3, 1, 1]),
                      ('conv3_3', [256, 256, 1, 1, 1]),
                      ('conv3_4', [256, 512, 3, 1, 1]),
                      ('pool3_stage1', [2, 2, 0]),
                      ('conv4_1', [512, 256, 1, 1, 1]),
                      ('conv4_2', [256, 512, 3, 1, 1]),
                      ('conv4_3', [512, 256, 1, 1, 1]),
                      ('conv4_4', [256, 512, 3, 1, 1]),
                      ('conv4_5', [512, 256, 1, 1, 1]),
                      ('conv4_6', [256, 512, 3, 1, 1]),
                      ('conv4_7', [512, 256, 1, 1, 1]),
                      ('conv4_8', [256, 512, 3, 1, 1]),
                      ('conv4_9', [512, 512, 1, 1, 1]),
                      ('conv4_10', [512, 1024, 3, 1, 1]),
                      ('pool4_stage1', [2, 2, 0]),
                      ('conv5_1', [1024, 512, 1, 1, 1]),
                      ('conv5_1', [1024, 512, 1, 1, 1]),
                      ])
        ...
        self.L1 = Stage(out_channel_from_vgg, 46, no_relu=True)
        self.L2 = Stage(out_channel_from_vgg + 46, 46, no_relu=True) 
        # self.L3 = Stage(130, 2, no_relu=True)
        # self.L4 = Stage(148, 20)
        # self.L5 = Stage(148, 20)
        # self.L6 = Stage(148, 20)

        self.S1 = Stage(out_channel_from_vgg + 46, 25) 
        self.S2 = Stage(out_channel_from_vgg + 46 + 25, 25) # 159 = 128+20+11
